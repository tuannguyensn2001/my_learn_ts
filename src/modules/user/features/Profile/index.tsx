...
import { BsBellFill, BsShieldLockFill } from 'react-icons/bs';
                    ...
                    <div className={styles['header']}>
                        ...
                        <div className={styles["header-other"]}>
                            ...
                            <div className={styles["header-other-avatar"]}>
                                <img width="100%" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpvmy_MjZETnhkHX8ZlB3eExZG9xu05S_7RA&usqp=CAU" alt="Profile Picture" />
                            </div>
                    ...
                    <div className={styles["sub-cover"]}>
                        ...
                        <div className={styles["info"]}>
                            ...
                            <div className={styles["info-avatar"]}>
                                <img className={styles["avatar"]} width="100%" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpvmy_MjZETnhkHX8ZlB3eExZG9xu05S_7RA&usqp=CAU" alt="Profile Picture" />
                            ...
                            <form className={styles["info-form"]} action="submit">
                                ...
                                <div className={styles["form-contact"]}>
                                    ...
                                    <div className={styles["form-contact-tel"]}>
                                        ...
                                        <input className={styles["input-field"]} type="tel" placeholder="Contact Number"/>
                                    </div>
